...
class DoublyLinkedList {
    ...
    insertAfter(targetVal, newVal) {
        ...
        while (runner) {
            if (runner.data === targetVal) {
                if (runner === this.tail) {
                    //insert after the tail, then update the tail
    ...
    // Try to annotate and check all the pointers. Some pointers are required to reset
    /**    3   5   7    8 
            p   r   n
...
list1.insertAtBackMany([5, 2, 1, 4, 7])
console.log(list1.toArray())
list1.insertAfter(1, 3)
console.log(list1.toArray())
list1.insertAfter(7, 10)
