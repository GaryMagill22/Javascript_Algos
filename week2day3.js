...
class BinarySearchTree {
    ...
    insert(newVal) {
        ...
        //base case saying that if our root is empty, then our root becomes our node 
        if (this.root === null) {
            this.root = node
            return this
        }
        ...
        while (true) {
            ...
            //new value is less than or equal to our current 
...
threeLevelTree.root.right.left = new BSTNode(11);
